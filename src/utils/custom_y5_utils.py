...
import torch
from src.utils.WBF.ensemble_boxes.ensemble_boxes_nms import nms
from src.utils.WBF.ensemble_boxes.ensemble_boxes_wbf import weighted_boxes_fusion as wbf
...
def ensemble_predict(
    ...
    for i in range(len(models)):
        ...
        prediction = (
            models[i](img, size=img_sizes[i], augment=augment).xyxyn[0].cpu().numpy()
        )
