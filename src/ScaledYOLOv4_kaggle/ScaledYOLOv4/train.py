...
if __name__ == '__main__':
    ...
    if not opt.evolve:
        ...
        if opt.global_rank in [-1, 0]:
            print('Start Tensorboard with "tensorboard --logdir %s", view at http://localhost:9091/' % opt.logdir)
            tb_writer = SummaryWriter(log_dir=f'/app/.tensorboard/{opt.name}')  # runs/exp
